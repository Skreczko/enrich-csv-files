# Generated by Django 3.2.6 on 2023-09-11 16:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('status', models.CharField(choices=[('in_progress', 'IN_PROGRESS'), ('finished', 'FINISHED'), ('failed', 'FAILED'), ('initiated', 'INITIATED')], default=csv_manager.enums.EnrichmentStatus['INITIATED'], help_text='Status of process of enrichment csv file', max_length=50)),
